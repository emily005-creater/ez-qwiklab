...
#echo ""
#echo -e "\033[1;32m===================================="
#echo -e "\033[1;32m   🌺ㅤFREE KEYS COLLECTIONSㅤ🌺  " 
#echo -e "\033[1;32m===================================="
#echo ""
...
echo -e "${red}Token is invalid or expired. Contact the developer WinKoKoOo  for more information.${plain}"
fi
